...
|---|---|---|---|
| Baseline | `ROLE_SWITCH_ENABLED=false` and `CONSOLIDATION_ENABLED=false`; controller observes traffic but does not call S2/S3 sidecars | `ROLE_SWITCH_ENABLED=true`, `CONSOLIDATION_ENABLED=true` | baseline has no S2/S3 controller execution log lines |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| strategy | 96 | 100.000 | 60.160 | 1.596 | 4.883 | 4.965 | 4.970 | 4.883 | 1600.063 | 1598.534 | 92 | 45.455 | 53.787 | 29.182 | 22590.000 |
