...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| prefill_peak | 24 | 100.00 | 100.00 | 7.16 | 3.35 | 2.15 | 2.55 | 2.55 | 11902.56 | 428.78 |
| decode_head | 24 | 100.00 | 100.00 | 8.32 | 2.88 | 2.81 | 2.84 | 2.97 | 2324.05 | 1005.54 |
| decode_tail | 24 | 100.00 | 100.00 | 10.99 | 2.18 | 2.51 | 2.83 | 3.14 | 941.22 | 831.67 |
| total | 72 | 100.00 | 100.00 | 29.99 | 2.40 | 2.55 | 2.84 | 2.97 | 3833.80 | 686.36 |

## 资源占用

- Request-window GPU allocated seconds: 142.24
- Request-window prefill allocated seconds: 28.45
- Request-window decode allocated seconds: 113.79
- Full-scenario GPU allocated seconds: 1181.69
- Avg ready workers: 5.00
- Min/Max ready workers: 5 / 5
...
- S2 only ?? controller ???? D->P?????? sidecar?????? S2 history????? prefill pressure ???? controller ??????
- ?????? S3????? migration ? scale down?
