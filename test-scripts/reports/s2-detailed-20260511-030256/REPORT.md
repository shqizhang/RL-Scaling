...
```json
{
    "status": "ok",
    "new_role": "prefill",
    "switch_time_ms": 393.1513058487326,
    "timings_ms": {
        "sleep": 62.674,
        "unregister_mdc": 7.131,
        "reconfig_nixl": 0.117,
        "reset_prefix_cache": 2.394,
        "register_mdc": 293.405,
        "wake": 27.38
    }
}
```

Wall-clock latency: **425.4ms**
...
| Metric                        | Value |
|-------------------------------|------:|
| Baseline (pre-switch)         | 1239 |
| After 10 prefill probes | 1239 |
...
```
[2m2026-05-11T03:02:54.541051Z[0m [33m WARN[0m [2mrl_scaling_sidecar._patch_self_pod_label[0m[2m:[0m [RLScalingSidecar] pod label patch returned HTTP 403: {"kind":"Status","apiVersion":"v1","metadata":{},"status":"Failure","message":"pods \"vllm-v1-disagg-router-vllmdecodeworker-7663d0d2-84dc55489ccjp8x\" is forbidden: User \"system:serviceaccount:dynam
[2m2026-05-11T03:03:03.266739Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Unregistering endpoint: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=backend, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-11T03:03:03.329168Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Unregistering model card: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=backend, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-11T03:03:03.619195Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Registering model card: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=prefill, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-11T03:03:03.642648Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Registering endpoint: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=backend, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-11T03:03:03.673454Z[0m [33m WARN[0m [2mrl_scaling_sidecar._patch_self_pod_label[0m[2m:[0m [RLScalingSidecar] pod label patch returned HTTP 403: {"kind":"Status","apiVersion":"v1","metadata":{},"status":"Failure","message":"pods \"vllm-v1-disagg-router-vllmdecodeworker-7663d0d2-84dc55489ccjp8x\" is forbidden: User \"system:serviceaccount:dynam
```
...
```json
{
    "status": "ok",
    "new_role": "decode",
    "switch_time_ms": 419.546338962391,
    "timings_ms": {
        "sleep": 40.788,
        "unregister_mdc": 12.551,
        "reconfig_nixl": 0.24,
        "reset_prefix_cache": 4.371,
        "register_mdc": 294.018,
        "wake": 67.55
    }
}
```

Wall-clock latency: **456.0ms**
...
| TARGET serves real prefill traffic (prompt_tokens Δ>0) | **true** (Δ=0) |
