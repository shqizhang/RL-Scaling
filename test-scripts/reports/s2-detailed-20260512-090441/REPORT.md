...
| Dedicated prefill worker           | `vllm-v1-disagg-router-vllmprefillworker-7663d0d2-64b454bd5gr974` | rl-scaling-fe78f1b652 |
...
```json
{
    "status": "ok",
    "new_role": "prefill",
    "switch_time_ms": 511.7124109528959,
    "timings_ms": {
        "sleep": 68.005,
        "unregister_mdc": 59.812,
        "reconfig_nixl": 0.162,
        "reset_prefix_cache": 4.497,
        "register_mdc": 288.127,
        "wake": 91.078
    }
}
```

Wall-clock latency: **547.2ms**
...
TARGET's discovered prefill_worker_id: ``
...
| Metric                        | Value |
|-------------------------------|------:|
| Baseline (pre-switch)         | 2946 |
| After 10 prefill probes | 2946 |
...
```
[2m2026-05-12T09:04:05.756431Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Unregistering endpoint: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=backend, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-12T09:04:05.860660Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Unregistering model card: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=prefill, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-12T09:04:06.220153Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Registering model card: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=backend, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-12T09:04:06.313978Z[0m [33m WARN[0m [2mdynamo_runtime::discovery::kube::daemon[0m[2m:[0m Failed to deserialize metadata from CR 'vllm-v1-disagg-router-vllmdecodeworker-7663d0d2-84dc55489ccjp8x': invalid type: null, expected a map
[2m2026-05-12T09:04:06.330031Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Registering endpoint: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=backend, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-12T09:04:06.362486Z[0m [33m WARN[0m [2mrl_scaling_sidecar._patch_self_pod_label[0m[2m:[0m [RLScalingSidecar] pod label patch returned HTTP 403: {"kind":"Status","apiVersion":"v1","metadata":{},"status":"Failure","message":"pods \"vllm-v1-disagg-router-vllmdecodeworker-7663d0d2-84dc55489ccjp8x\" is forbidden: User \"system:serviceaccount:dynam
[2m2026-05-12T09:04:49.065195Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Unregistering endpoint: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=backend, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-12T09:04:49.132732Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Unregistering model card: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=backend, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-12T09:04:49.473310Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Registering model card: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=prefill, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-12T09:04:49.497212Z[0m [32m INFO[0m [2mdynamo_runtime::discovery::kube[0m[2m:[0m Registering endpoint: namespace=dynamo-system-vllm-v1-disagg-router-7663d0d2, component=backend, endpoint=generate, instance_id=b63356c1f6a36
[2m2026-05-12T09:04:49.590589Z[0m [33m WARN[0m [2mrl_scaling_sidecar._patch_self_pod_label[0m[2m:[0m [RLScalingSidecar] pod label patch returned HTTP 403: {"kind":"Status","apiVersion":"v1","metadata":{},"status":"Failure","message":"pods \"vllm-v1-disagg-router-vllmdecodeworker-7663d0d2-84dc55489ccjp8x\" is forbidden: User \"system:serviceaccount:dynam
```
...
```json
{
    "status": "ok",
    "new_role": "decode",
    "switch_time_ms": 458.08618189767003,
    "timings_ms": {
        "sleep": 80.297,
        "unregister_mdc": 12.572,
        "reconfig_nixl": 0.136,
        "reset_prefix_cache": 4.043,
        "register_mdc": 332.626,
        "wake": 28.394
    }
}
```

Wall-clock latency: **496.9ms**
...
- HTTP 200: **10**
- Errors: **0**
- **TARGET served as decode worker: 5/10**

TARGET prompt_tokens delta during post-revert probes: **81**
...
| TARGET serves real prefill traffic (prompt_tokens Δ>0) | **false** (Δ=0, served=0/30) |
| All post-revert chats succeed | **10/10** |
| TARGET serves decode after revert | **true** (5/10) |
| **OVERALL** | **false** |
